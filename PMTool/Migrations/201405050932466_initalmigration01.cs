namespace PMTool.Migrations
{
    ...
    public partial class initalmigration01 : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        TaskHour = c.Decimal(nullable: false, precision: 18, scale: 2),
                        RemainingHour = c.Decimal(precision: 18, scale: 2),
                        Description = c.String(),
                        CreatedBy = c.Int(nullable: false),
                        ModifiedBy = c.Int(nullable: false),
                        CreateDate = c.DateTime(nullable: false),
            ...
            CreateTable(
                ...
                c => new
                    {
                        ID = c.Long(nullable: false, identity: true),
                        SchedulerTitleID = c.Int(nullable: false),
                        ProjectID = c.Long(nullable: false),
                        ScheduleTypeID = c.Int(nullable: false),
                        ScheduledTime = c.String(),
                        RecipientUserType = c.Int(),
                        ScheduledDay = c.Int(),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.EmailSchedulers", "ProjectID", "dbo.Projects");
            DropForeignKey("dbo.EmailSchedulers", "ModifiedBy", "dbo.UserProfile");
            DropForeignKey("dbo.EmailSchedulers", "CreatedBy", "dbo.UserProfile");
            ...
            DropIndex("dbo.EmailSchedulers", new[] { "ProjectID" });
            DropIndex("dbo.EmailSchedulers", new[] { "ModifiedBy" });
            DropIndex("dbo.EmailSchedulers", new[] { "CreatedBy" });
